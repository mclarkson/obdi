...
# Systemd
install -D -m 755 init/obdi.service ${RPM_BUILD_ROOT}/%{_unitdir}/obdi.service
install -D -m 755 init/obdi-worker.service ${RPM_BUILD_ROOT}/%{_unitdir}/obdi-worker.service
